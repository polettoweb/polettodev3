  ...
  return (
    <footer className={`text-white m-0 p-0 bubble-footer ${theme === 'relax' ? 'bg-copy-primary' : 'bg-copy-secondary'}`}>
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between py-4 svg-top">
        ...
        <div className="my-6 lg:my-0">
          <div>
            <a href="rss.xml" className="text-white font-normal"
            >RSS Feed</a
            >
            &nbsp;|&nbsp;
            <a
        ...
        <ul className="my-6 lg:my-0 flex items-center">
          <li className="mx-4">
            <a
              href="https://www.linkedin.com/in/marco-poletto-96853774/"
              target="_blank"
              className="text-white hover:text-gray-400"
              title="Linkedin page" rel="noreferrer"
            >
          ...
          <li className="mx-4">
            <a
              ...
              target="_blank"
              className="text-white hover:text-gray-400"
              title="Dev.to page" rel="noreferrer"
            >
              <svg width="24" height="24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <li className="mx-4">
            <a
              ...
              target="_blank"
              className="text-white hover:text-gray-400"
              title="Codepen page" rel="noreferrer"
            >
              <svg width="24" height="24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <li className="mx-4">
            <a
              ...
              target="_blank"
              className="text-white hover:text-gray-400"
              title="YouTube channel" rel="noreferrer"
            >
          ...
          <li className="mx-4">
            <a
              ...
              target="_blank"
              className="text-white hover:text-gray-400"
              title="GitHub page" rel="noreferrer"
            >
          ...
          <li className="mx-4">
            <a
              ...
              target="_blank"
              className="text-white hover:text-gray-400"
              title="Twitter page" rel="noreferrer"
            >
